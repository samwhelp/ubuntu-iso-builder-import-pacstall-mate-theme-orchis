...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-mate-theme-orchis"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-mate-theme-orchis/iso-profile
"
echo
