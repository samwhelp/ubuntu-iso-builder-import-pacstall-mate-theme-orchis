...
| `=` |
| [ubuntu-iso-builder-include-pacstall-mate-theme-orchis](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-mate-theme-orchis) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-mate-theme-orchis/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-mate-theme-orchis/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-mate-theme-orchis/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-import-pacstall-mate-theme-orchis](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-mate-theme-orchis)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-mate-theme-orchis.git
```


> change dir to `ubuntu-iso-builder-import-pacstall-mate-theme-orchis`

``` sh
cd ubuntu-iso-builder-import-pacstall-mate-theme-orchis
```
...
> change dir to `~/work/ubuntu-iso-builder-import-pacstall-mate-theme-orchis/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-import-pacstall-mate-theme-orchis/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-import-pacstall-mate-theme-orchis/iso-profile/dist`
